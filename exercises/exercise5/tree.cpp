...
public:
	...
	public:
		...
		T operator * ()
		{
			...
			//ñèãóðíè ñìå, ÷å íà âúðõà íà ñòåêà
			//ñòîè ÷èñëî "çà ïå÷àòàíå"
...
private:
	...
	/*
	//ïðåïîäëîãàìå, ÷å èìåìå T::operator +
	//n - êîëêî åëåìåíòà ÎÑÒÀÂÀ äà ñóìèðàìå
...
public:
	...
	/*
	àêî ðàçãëåæäàìå åëåìåíòè íà ÄÍÄ êàòî
	ðåäèöà îò ÷èñëà, ïîäðåäåíè â íàðàñòâàù ðåä,
	äà ñå íàìåðè ñóìàòà íà ïúðâàòà ïîëîâèíàòà íà ðåäèöàòà
...
void BTree<T>::LeftRightRootIterator::unwind()
{
	...
	//ñòåêúò å èëè ïðàçåí èëè íà âúðõà ìó èìà îïåðàöèÿ PRINT
}
...
void BTree<T>::deleteElement(Node<T> *&subTreeRoot, const T&x)
{
	...
	//âå÷å ñìå ñèãóðíè, ÷å òðèåì êîðåíà!
	//îñâåí òîâà ñìå ñèãóðíè, ÷å êîðåíà èìà ÏÎÍÅ ÅÄÈÍ
	//íàñëåäíèê

	//òðèåíå íà êîðåí ñàìî ñ 1 íàñëåäíèê
	...
	//òðèåíå íà êîðåí ñàìî ñ 1 íàñëåäíèê
	//òîçè ñëó÷é ìîæå äà íå ñå ðàçãëåæäà
	...
	//òðèåíå íà êîðåíà
	//âå÷å ñìå ñèãóðíè, ÷å êîðåíà èìà òî÷íî äâà íàñëåäíèêà
